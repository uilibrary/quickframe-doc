...
- [Step-2](#step-2) : Open the _`src/App.jsx`_ file then import the AuthProvider from _`contexts/firebaseContext`_ and wrap the App component with it.
